...
<div class="services technology big-banner" id="data-management">
    ...
    <div class="cards">
        <div class="card">
            <img src="../img/services/card-1.png" title="<?= _('Data Lake') ?>" />
            <h3><?= _('Data Lake') ?></h3>
        ...
        <div class="card">
            <img src="../img/services/card-2.png" title="<?= _('Data Warehouse') ?>" />
        ...
        <div class="card">
            <img src="../img/services/card-3.png" title="<?= _('ETL') ?>" />
            <h3><?= _('ETL') ?></h3>
...
<div class="services technology big-banner ai" id="ai">
    ...
    <div class="cards">
        <div class="card">
            <img src="../img/services/card-4.png" title="<?= _('Customer Segmentation') ?>" />
            <h3><?= _('Customer Segmentation') ?></h3>
            <p><?= _('We are experts at creating data repositories in their natural format in a way that fulfils the specific needs of our clients thus creating a centralized and strong base so that the different parts of the company can use this source of information to develop their own projects.') ?></p>
        </div>
        <div class="card">
            <img src="../img/services/card-5.png" title="<?= _('Search of Optimal Paths') ?>" />
            <h3><?= _('Search of Optimal Paths') ?></h3>
            <p><?= _('We take care of understanding the problems of our customers in order to decide which is the optimal format in which their data should be stored.') ?></p>
        </div>
        <div class="card">
            <img src="../img/services/card-6.png" title="<?= _('Record Linkage') ?>" />
        ...
        <div class="card">
            <img src="../img/services/card-7.png" title="<?= _('Time Series Prediction') ?>" />
        ...
        <div class="card">
            <img src="../img/services/card-8.png" title="<?= _('Conversion Probability Estimation') ?>" />
        ...
        <div class="card">
            <img src="../img/services/card-9.png" title="<?= _('Pricing Optimization') ?>" />
        ...
        <div class="card">
            <img src="../img/services/card-10.png" title="<?= _('Text Analysis') ?>" />
            <h3><?= _('Text Analysis') ?></h3>
            <p><?= _('We are able to model any type of time series that has an implicit pattern, such as predicting product demands, prices or cash flows, using classic statistical techniques.') ?></p>
        </div>
        <div class="card">
            <img src="../img/services/card-11.png" title="<?= _('Recommendation Systems') ?>" />
            <h3><?= _('Recommendation Systems') ?></h3>
            <p><?= _('We can estimate the probability of purchasing a product in a particular context using advanced classification algorithms. Something very valuable in terms of eCommerce, where knowing how much to bet on a product determines the profitability of an online marketing policy.') ?></p>
        </div>
        <div class="card">
            <img src="../img/services/card-12.png" title="<?= _('Image Recognition') ?>" />
...
<div class="services technology big-banner viz" id="visualization">
    ...
    <div class="cards">
        <div class="card">
            <img src="../img/services/card-13.png" title="<?= _('Business Intelligence Tools') ?>" />
        ...
        <div class="card">
            <img src="../img/services/card-14.png" title="<?= _('Dashboards') ?>" />
            <h3><?= _('Dashboards') ?></h3>
        ...
        <div class="card">
            <img src="../img/services/card-15.png" title="<?= _('High Dimensions Visualization') ?>" />
